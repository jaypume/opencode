...
flowchart TB
    ...
    style OpenCode fill:#e1f5ff
    style External fill:#ffe1f5
    style Users fill:#f0f0f0
```

**说明**：
- **开发者**：使用 CLI 或 Desktop 进行日常开发
- **团队管理员**：通过 Web 控制台管理账户、配额、自定义模型
- **OpenCode 系统**：提供多端统一的 AI 编程助手体验
- **外部系统**：LLM 提供商、本地模型、MCP 工具、LSP 服务、Git 仓库
